...
| **Current task** | `3.3.1` — deploy backend (Railway/Render), provision Postgres |
| **Recently merged** | Sprints 0–2 complete; Sprint 3.1–3.2 complete as of 2026-08-13 |
| **Status** | 🟢 Sprint 0, 1 and 2 all done. Sprint 3.1 (dashboard) and 3.2 (interstitial) code-complete; both have a real-browser manual verification step still pending (same category as D7/D8). Moving to 3.3 (deployment) |
| **Blocked?** | No |

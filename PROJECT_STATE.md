...
| **Current sprint** | Sprint 2 — Rigorous evaluation and the remaining defects |
| **Current task** | `2.7.1` — benchmark `/analyze` p50/p95, VT cache cold/warm |
| **Recently merged** | Sprints 0–1 complete; Sprint 2.1–2.6 complete as of 2026-08-13 |
| **Status** | 🟢 Sprint 0 and Sprint 1 done and verified. Sprint 2: 2.1–2.6 done (evaluation protocols, baselines, calibration, faithfulness, ADR-015, D7/D8 fix); 2.7 (latency) remaining |
| **Blocked?** | No |

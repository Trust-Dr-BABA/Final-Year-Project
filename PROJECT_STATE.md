...
| **Current task** | `3.1.1` — `npm install recharts date-fns`, start the dashboard pages |
| **Recently merged** | Sprints 0–2 complete as of 2026-08-13 |
| **Status** | 🟢 Sprint 0, 1 and 2 all done and verified (2.1–2.8, including the added brand-matching item, L1). Moving to Sprint 3 |
| **Blocked?** | No |

...
| **Current task** | Sprint 0 complete — move to Sprint 1 (`1.1.1`, `ml/scripts/audit_dataset.py`) |
| **Recently merged** | `origin/main` (13 commits) on 2026-08-09 — Alembic migration, extension icons, `webNavigation` fix |
| **Status** | 🟢 Sprint 0 done — all tasks verified, CI green on `main` (`8378be5`), extension load confirmed in a real browser |
| **Blocked?** | No |
